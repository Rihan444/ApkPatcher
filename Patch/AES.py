        ...
        for file_path in file_paths:
            ...
            if matches:
                ...
                for m in matches:
                    ...
                    if f"invoke-static {invoke_pv}, BHHC_Tips_&_Tricks/AES;->getInstance(Ljava/lang/Object;)V" not in updated_content:
                        injected_lines = [
                            f"invoke-static {invoke_pv}, BHHC_Tips_&_Tricks/AES;->getInstance(Ljava/lang/Object;)V",
                            ...
                            f"invoke-static {{{result_pv}}}, BHHC_Tips_&_Tricks/AES;->getInstance(Ljava/lang/Object;)V",
                        ]
                        match_text = m[0]
                        replacement_text = "\n    ".join(injected_lines)
            ...
            for file_path in matched_files:
                ...
                if matches:
                    ...
                    for m in matches:
                        ...
                        injected_lines = []
                        if param_count == 1:
                            injected_lines.append(f"invoke-static {{{invoke_args_list[0]}}}, BHHC_Tips_&_Tricks/AES;->a(Ljava/lang/Object;)V")
                            injected_lines.append(f"invoke-static {{{invoke_args}}}, {match}\n    move-result-object {result_register}")
                            injected_lines.append(f"invoke-static {{{result_register}}}, BHHC_Tips_&_Tricks/AES;->a(Ljava/lang/Object;)V")
                        elif param_count > 1:
                            for idx, param in enumerate(invoke_args_list, start=1):
                                injected_lines.append(f"invoke-static {{{param}}}, BHHC_Tips_&_Tricks/AES;->b{idx}(Ljava/lang/Object;)V")
                            injected_lines.append(f"invoke-static {{}}, BHHC_Tips_&_Tricks/AES;->b()V")
                            injected_lines.append(f"invoke-static {{{invoke_args}}}, {match}\n    move-result-object {result_register}")
                            injected_lines.append(f"invoke-static {{{result_register}}}, BHHC_Tips_&_Tricks/AES;->a(Ljava/lang/Object;)V")
...
def Copy_AES_Smali(decompile_dir, smali_folders, manifest_path, isAES_MS, isAPKEditor):
    ...
    # ---------------- Copy AES.smali ----------------
    Target_Dest = M.os.path.join(L_S_C_F, 'BHHC_Tips_&_Tricks', 'AES.smali')
