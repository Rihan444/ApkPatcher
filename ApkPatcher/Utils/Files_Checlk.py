...
class FileCheck:
    ...
    def Download_Files(self, Jar_Files):
        ...
        for File_URL, File_Path, Expected_CheckSum in Jar_Files:
            ...
            try:
                Version = requests.get("https://raw.githubusercontent.com/Rihan444/ApkPatcher/main/VERSION").text.strip()

                if Version != str(__version__):
                    print(f"\n{C.S} Updating {C.E} {C.OG} ApkPatcher ➸❥ {C.G}{Version}...\n\n")

                    if M.os.name == "nt":
                        cmd = "pip install --force-reinstall git+https://github.com/Rihan444/ApkPatcher.git"
                    else:
                        cmd = "pip install --force-reinstall https://github.com/Rihan444/ApkPatcher/archive/refs/heads/main.zip"
    ...
    def F_D(self):
        ...
        self.Download_Files(
            [
                (
                    "https://github.com/Rihan444/Tools/releases/download/Tools/APKEditor.jar",
                    self.APKEditor_Path,
                    "6b766e71ed5f4c7cce338e74a1ab786cc1ecc1896d9f37f9f1bf639398e5eadc"
                ),
                (
                    "https://github.com/Rihan444/Tools/releases/download/Tools/APKTool.jar" if M.os.name == 'nt' else "https://github.com/Rihan444/Tools/releases/download/Tools/APKTool_Termux.jar",
                ...
                (
                    "https://github.com/Rihan444/Tools/releases/download/Tools/Uber-Apk-Signer.jar",
                    self.Sign_Jar,
                    "e1299fd6fcf4da527dd53735b56127e8ea922a321128123b9c32d619bba1d835"
                ),
                (
                    "https://raw.githubusercontent.com/Rihan444/Objectlogger/refs/heads/main/Hook.smali",
                    self.Hook_Smali,
                    "c62ac39b468eeda30d0732f947ab6c118f44890a51777f7787f1b11f8f3722c4"
                ),
                (
                    "https://raw.githubusercontent.com/Rihan444/Objectlogger/refs/heads/main/AES.smali",
                    self.AES_Smali,
                    "09db8c8d1b08ec3a2680d2dc096db4aa8dd303e36d0e3c2357ef33226a5e5e52"
                ),
                (
                    "https://github.com/Rihan444/Tools/releases/download/Tools/lib_Pairip_CoreX.so",
                    self.Pairip_CoreX,
                ...
                # ---------------- Pine HooK Source ----------------
                (
                    "https://github.com/Rihan444/PineHookPlus/releases/download/v1.0/config.json",
                    self.config,
                    "da5eef2fa153068e19fca6fabfd144fbb9d7075a61e333814369bd36c51289c1"
                ),
                (
                    "https://github.com/Rihan444/PineHookPlus/releases/download/v1.0/libpine32",
                    self.libpine32,
                    "94854417f9bbb4e2dc49a5edede51dfc1eafca2c7cbb163f59585da7d97fc5db"
                ),
                (
                    "https://github.com/Rihan444/PineHookPlus/releases/download/v1.0/libpine64",
                    self.libpine64,
                    "d3e415243b80b866d2c75408cc9a26ba4fcab0775f798442f9a622097d845e0c"
                ),
                (
                    "https://github.com/Rihan444/PineHookPlus/releases/download/v1.0/loader.dex",
                    self.loader,
    ...
    def F_D_A(self):
        ...
        self.Download_Files(
            [
                (
                    "https://github.com/Rihan444/Tools/releases/download/Tools/APKTool.jar",
                    self.APKTool_Path_E,
