...
`💢 For Latest Commit ( From Main  Branch )  💢`
    ...
    pip install --force-reinstall https://github.com/Rihan444/ApkPatcher/archive/refs/heads/main.zip

`OR`

    pip install --force-reinstall https://github.com/Rihan444/ApkPatcher/archive/refs/heads/main.tar.gz

`OR`

    curl -Ls https://github.com/Rihan444/Tools/releases/download/Tools/ApkPatcher.sh | bash

**2nd. Method**

    pkg install python git && pip install git+https://github.com/Rihan444/ApkPatcher.git
...
`For Flutter, Script By  🇧🇩 BHHC Infinity Tech 🇧🇩`
...
**Flag: `-t` ➸ Telegram / Plus Patch, Script By  🇧🇩 BHHC Infinity Tech 🇧🇩**
